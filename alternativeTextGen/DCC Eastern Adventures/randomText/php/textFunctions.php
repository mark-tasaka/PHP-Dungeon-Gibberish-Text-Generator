...
{
    $word = array('Abumi-guchi', 'Abura-akago', 'Abura-sumashi', 'Akabeko', 'Akaname', 'Akashita', 'Akateko', 'Akkorokamui', 'Akubōzu', 'Akurojin-no-hi', 'Amabie', 'Amaburakosagi', 'Amamehagi', 'Amanojaku', 'Amanozako', 'Amaterasu', 'Amazake-babaa', 'Amefurikozō', 'Amemasu', 'Ameonna', 'Amikiri', 'Amorōnagu', 'Anmo', 'Aoandon', 'Aobōzu', 'Aonyōbō', 'Aosaginohi', 'Arikura-no-baba', 'Ashimagari', 'Ashinagatenaga', 'Ayakashi (yōkai)', 'Azukiarai (or Azukitogi)', 'Bake-kujira', 'Bakeneko', 'Bakezōri', 'Baku (spirit)', 'Basan', 'Bashōnosei', 'Betobeto-san', 'Binbōgami', 'Biwa-bokuboku', 'Buruburu', 'Byakko', 'Byōbunozoki', 'Chōchinbi', 'Chōchinobake', 'Daidarabotchi', 'Daitengu', 'Danzaburou-danuki', 'Datsue-ba', 'Dodomeki', 'Donotsura', 'Enenra', 'Enkō', 'Funayūrei', 'Furaribi', 'Furu-utsubo', 'Furutsubaki-in-the-king', 'Futakuchi-onna', 'Fūjin', 'Fūri', 'Gagoze', 'Gaki', 'Gashadokuro', 'Genbu', 'Goryō', 'Gozu and Mezu', 'Guhin', 'Gyūki', 'Hachishaku-sama', 'Hakanohi', 'Hakuja on Myojin', 'Hakutaku', 'Hanako-san', 'Hannya', 'Haradashi', 'Harionago', 'Hashihime', 'Heikegani', 'Hibagon', 'Hiderigami', 'Hihi', 'Hikeshibaba', 'Hinode', 'Hitodama', 'Hitotsume-kozō', 'Hitotsume-nyūdō', 'Hiyoribō', 'Hoji', 'Hone-onna', 'Hoshi-no-Tama', 'Hotoke', 'Hyakki Yakō', 'Hyōsube', 'Hō-ō', 'Hōsōshi', 'Ibaraki-doji', 'Ichiren-Bozu', 'Ikiryō', 'Ikuchi', 'Inugami Gyoubu', 'Inugami', 'Isonade', 'Issie', 'Itsumade', 'Ittan-momen', 'Iyaya', 'Jami', 'Janjanbi', 'Jatai', 'Jibakurei', 'Jikininki', 'Jinmenju', 'Jishin-namazu', 'Jorōgumo', 'Jubokko', 'Kahaku (河伯)', 'Kakurezato', 'Kamaitachi', 'Kambarinyūdō', 'Kameosa', 'Kanedama', 'Kappa', 'Karasu-tengu', 'Karura', 'Kasa-obake', 'Kasha', 'Katawaguruma', 'Kawaakago', 'Kawauso', 'Kechibi', 'Keneō', 'Keukegen', 'Kijimuna', 'Kirin', 'Kitsune no yomeiri', 'Kitsune', 'Kitsunebi', 'Kiyohime', 'Kodama', 'Kokakuchō', 'Komainu', 'Konaki-jiji', 'Konoha-tengu', 'Koromodako', 'Koropokkuru', 'Kosenjōbi', 'Kosode-us', 'Kubikajiri', 'Kuchisake-onna', 'Kuda-gitsune', 'Kudan', 'Kumo Yōkai', 'Kyonshī', 'Kyōkotsu', 'Kyōrinrin', 'Mekurabe', 'Miage-nyūdō', 'Mikaribaba', 'Mikoshi-nyūdō', 'Misaki', 'Mizuchi', 'Mokumokuren', 'Momonjī', 'Mononoke', 'Morinji-no-kama', 'Mujina', 'Myōbu', 'Mōryō', 'Namahage', 'Namazu', 'Nekomata', 'Ningyo', 'Nobusuma', 'Noderabō', 'Nogitsune', 'Noppera-bō', 'Nozuchi', 'Nue', 'Nukekubi', 'Nuppeppo', 'Nurarihyon', 'Nure-onna', 'Nuribotoke', 'Nurikabe', 'Nyūdō-bōzu', 'Nyūnaisuzume', 'Obake (or Bakemono)', 'Obariyon', 'Oboroguruma', 'Oiwa', 'Okiku', 'Okuri-inu', 'Oni of Rashomon', 'Oni', 'Onibaba', 'Onibi', 'Onihitokuchi', 'Onikuma', 'Onmoraki', 'Onmyoji', 'Onryō', 'Osakabe', 'Otoroshi', 'Raijin', 'Raijū', 'Rokurokubi', 'Ryuu', 'Rōjinbi', 'Sa Gojō', 'Samebito', 'Sankai', 'Sansei', 'Sarakazoe', 'Satori', 'Sazae-oni', 'Seiryū', 'Sesshō-seki', 'Shachihoko', 'Shibaemon-tanuki', 'Shichinin Misaki', 'Shidaidaka', 'Shikigami', 'Shikome', 'Shinigami', 'Shiranui', 'Shirime', 'Shiryō', 'Shirōneri', 'Shisa', 'Shishi', 'Shuten-doji', 'Shōjō', 'Shōkera', 'Son Gokū', 'Suiko', 'Sunakake Baba', 'Sunekosuri', 'Suzaku', 'Suzuri-no-tamashii ', 'Sōjōbō', 'Taka-onna', 'Tamamo-no-Mae', 'Tanuki', 'Te-me', 'Teke Teke', 'Ten', 'Tengu', 'Tenjōkudari ', 'Tenka (kaika) ', 'Tenko (fox) ', 'Tennin', 'Teratsutsuki ', 'Tesso', 'Tsuchigumo', 'Tsuchinoko', 'Tsukinowaguma', 'Tsukumogami', 'Tsukuyomi', 'Tsurube-otoshi', 'Tōfu-kozō', 'Ubume', 'Uma-no-ashi', 'Umi-nyōbō', 'Umibōzu', 'Ungaikyō', 'Ushi-no-tokimairi', 'Ushi-oni', 'Ushi-onna', 'Ushirogami ', 'Uwan', 'Waira', 'Wani', 'Wanyūdō', 'Yadōkai', 'Yama-biko', 'Yama-inu', 'Yama-uba', 'Yamajijii', 'Yamako', 'Yamaoroshi', 'Yamata no Orochi', 'Yashima no Hage-tanuki', 'Yatagarasu', 'Yato-no-kami', 'Yobuko', 'Yomotsu-shikome', 'Yonakinoishi', 'Yosuzume', 'Yuki-onna', 'Yurei', 'Yōkai' , 'Youkai', 'Yōsei', 'Zashiki-warashi', 'Zennyo Ryūō', 'Zorigami', 'Zuijin', 'Zunbera-bō', 'Ōgama', 'Ōkaburo ', 'Ōkami', 'Ōkubi', 'Ōmagatoki', 'Ukmukade', 'Ōnyūdō');
